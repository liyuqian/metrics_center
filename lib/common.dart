...
abstract class MetricsCenter
    implements MetricSource<MetricPoint>, MetricDestination {
  ...
  Future<void> pushToDestination(MetricDestination destination) async {
    ...
    List<MetricPoint> points =
        (await getUpdatesAfter(dstUpdateTime[destination.id]))
            .where(
  ...
  Future<void> pullFromSource(MetricSource source) async {
